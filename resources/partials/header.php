<nav class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex flex-wrap justify-content-between fixed bg-color-1 p-2">
  <div class="col-xl-3 col-lg-3 col-md-2 col-sm-2 d-flex flex-wrap links">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex flex-wrap justify-content-start">
      <a class="logo" href="./index.php">sudoarturo</a>
    </div>
  </div>
